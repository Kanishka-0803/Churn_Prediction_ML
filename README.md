...
🔄 Project Workflow
Data Collection — 10,127 records across banking operations.
Exploratory Data Analysis (EDA) — Analyzed feature distributions, category breakdowns (e.g. Blue Card dominance, income categories), and correlation with churn.
Data Preprocessing — Label encoding, ordinal/dummy encoding for categorical variables, StandardScaler feature scaling, and train-test splitting.
Model Building — Trained and compared three classifiers: Decision Tree, Random Forest, and Gradient Boosting.
Evaluation & Tuning — Used GridSearchCV to optimize hyperparameters, evaluating models on Accuracy, Precision, Recall, and F1-Score, with emphasis on Recall since missing an actual churner is the costliest error.
Deployment & Action — Outputs support proactive intervention workflows for customer retention.
🤖 Models & Results
